...
public class MastersBLL
{
    ...
    private string currency, brandName, website, notes, logo, component, collectionType, colorName, hexCode, 
        ...
        occaission, promotionOccasion, occasionAbbre, style, assembly, material, ipaddress, _subCategoryNames = "";
    ...
    public string SubCategoryNames { set { _subCategoryNames = value; } get { return _subCategoryNames; } }
    ...
    public int AddBrand()
    {
        ...
        obj.AddParam("@ipaddress", this.ipaddress);
        obj.AddParam("@sub_cat_names", this._subCategoryNames);
        i = obj.ExecuteNonQuery();
        return i;
