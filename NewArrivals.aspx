<%@ Page Title="NewArrivals" Language="C#" MasterPageFile="~/masterpages/HomePage.master" AutoEventWireup="true" CodeFile="NewArrivals.aspx.cs" Inherits="NewArrivals" %>
                        ...
                        <div class="row">
                            <div class="product-one">
                                ...
                                <telerik:RadListView runat="server" ID="RadListView1" AllowPaging="True" DataKeyNames="pid" PageSize="12" OnItemDataBound="DataList1_ItemDataBound" OnPageIndexChanged="RadListView1_PageIndexChanged">
                                    ...
                                    <ItemTemplate>
                                         <div class="col-md-3  product-left" style="padding-bottom: 25px;">
                                                    <div class="product-main simpleCart_shelfItem">
                                                        ...
                                                        <a href="product_details.aspx?cid=<%# Eval("cid") %>&pid=<%# Eval("pid") %>&dis_price=<%# Eval("discount_percentage_amt") %>" class="mask">
                                                            <%--<img class="img-responsive zoom-img" src="images/13-tm_home_default.jpg" alt="" />--%>
