<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="add_VAT.aspx.cs" Inherits="admin_add_VAT" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table class="txt" style="width: 100%;" align="center" cellpadding="3" cellspacing="5">
                ...
                <tr>
                    <td align="center" colspan="2" class="header_title">GST</td>
                </tr>

                <tr>
                    <td align="left" colspan="2">&nbsp;<telerik:RadButton ID="btnAddNew" runat="server" Skin="Silk" Text="Add New GST" OnClick="btnAddNew_Click">
                    </telerik:RadButton>
                        &nbsp;<telerik:RadButton ID="btnView" runat="server" Skin="Silk" Text="View GST" OnClick="btnView_Click">
                        </telerik:RadButton>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width: 100%">
                        <asp:Panel ID="PanelAdd" runat="server" GroupingText="Add New GST">
                            <table class="txt" style="width: 100%;" align="center" cellpadding="3" cellspacing="5">
                                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 100%">
                        <asp:Panel ID="PanelView" runat="server" GroupingText="View GST">
                                ...
                                <tr>
                                    <td style="width: 985px;">
                                        ...
                                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                                            AllowSorting="True" DataSourceID="DSVat" GridLines="None" PageSize="20"
                                            Skin="Default">
                                            <HeaderContextMenu EnableAutoScroll="True">
                                            </HeaderContextMenu>


                                            <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" DataSourceID="DSVat" DataKeyNames="id">
                                                <RowIndicatorColumn>
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-Font-Underline="false">
                                                        ...
                                                        <ItemTemplate>
                                                            <a href="add_VAT.aspx?id=<%#Eval("id") %>">
                                        ...
                                        <asp:SqlDataSource ID="DSVat" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                                            SelectCommand="SELECT * FROM vat_tbl order by id desc"></asp:SqlDataSource>
