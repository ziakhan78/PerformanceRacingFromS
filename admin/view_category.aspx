<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_category.aspx.cs" Inherits="admin_view_category" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Category</td>
                </tr>
                                ...
                                <tr>
                                    <td valign="top" align="left">
                                        <asp:RadioButtonList ID="rbtnSearch" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Selected="True" Value="0">Category Name</asp:ListItem>
                                        </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><b>
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server"
                                                ...
                                                <asp:ListItem Value="2">Non Bike</asp:ListItem>
                                                 <asp:ListItem Value="3">Riding Gear</asp:ListItem>
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="cid">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                  ...
                                  <telerik:GridTemplateColumn HeaderText="Thumbnail">
                                    ...
                                    <telerik:GridBoundColumn DataField="cat_name" HeaderText="Category Name"
                                       ...
                                       <telerik:GridBoundColumn DataField="type" HeaderText="Type"
                                        ...
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" Font-Underline="true" Width="100px" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_category.aspx?id=<%# Eval("cid") %>'>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="imgDeleteP" CommandName="Delete" ToolTip="Delete"
                                                CommandArgument='<%# Eval("cid") %>' runat="Server"
               ...
               <%-- <tr>
                    ...
                    <td  colspan="3">
                        ...
                        <telerik:RadListBox ID="RadListBox1" runat="server" AllowReorder="True" DataKeyField="cid" DataSourceID="SqlDataSource1" DataTextField="cat_name" DataValueField="cid" Width="100%" Skin="Default">
                        </telerik:RadListBox>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT cid, cat_name FROM [Category_tbl] order by display_order "></asp:SqlDataSource>
                 ...
                 <tr>
                    <td align="center"  colspan="2"><asp:Button ID="btnUpdateOrder" runat="server" Text="Update Order" OnClick="btnUpdateOrder_Click" CssClass="btn" /></td>
                </tr>--%>
