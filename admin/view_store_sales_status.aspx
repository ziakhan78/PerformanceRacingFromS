<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_store_sales_status.aspx.cs" Inherits="admin_view_store_sales_status" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="txt" style="width: 100%;">
                <tr>
                    <td class="header_title" colspan="3">View Store Sales Status</td>
                </tr>
