<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_subsubcategory.aspx.cs" Inherits="admin_view_subsubcategory" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Sub Sub Category</td>
                </tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="center" width="100%">
                                        ...
                                        <asp:DropDownList ID="ddlCat" runat="server" AppendDataBoundItems="True"
                                            RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="ddlCat_SelectedIndexChanged" DataSourceID="dsCat" DataTextField="cat_name" DataValueField="cid" CssClass="txt">
                                            <asp:ListItem Text="All" >All</asp:ListItem>
                                        </asp:DropDownList>

                                        <asp:SqlDataSource ID="dsCat" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT * FROM [Category_tbl] order by cat_name asc"></asp:SqlDataSource>
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="ssid">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                  ...
                                  <%--  <telerik:GridTemplateColumn HeaderText="Thumbnail">
                                        <ItemTemplate>
                                            <img src='../CategoryImages/<%#Eval("subcat_image") %>' alt="" style="border-width: 0px; height: 50px; width: 50px;" />
                                        </ItemTemplate>
                                        <ItemStyle Width="50px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                                    </telerik:GridTemplateColumn>--%>


                                       <telerik:GridBoundColumn DataField="subsubcat_name" HeaderText="Sub Sub Category"
                                        SortExpression="subsubcat_name" UniqueName="subcat_name">
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" Font-Underline="true" Width="390px" />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="390px"></ItemStyle>
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="subcat_name" HeaderText="Sub Category"
                                        SortExpression="subcat_name" UniqueName="subcat_name">
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" Font-Underline="true" Width="390px" />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="390px"></ItemStyle>
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="cat_name" HeaderText="Category"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_subsubcategory.aspx?id=<%# Eval("ssid") %>'>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="imgDeleteP" CommandName="Delete" ToolTip="Delete"
                                                CommandArgument='<%# Eval("ssid") %>' runat="Server"
