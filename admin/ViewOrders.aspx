<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="ViewOrders.aspx.cs" Inherits="admin_ViewOrders" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="txt" style="width: 100%;">
                <tr>
                    <td class="header_title" colspan="3">View Online Sales Reports</td>
                </tr>
                            ...
                            <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" DataSourceID="dsOrders">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Order No." SortExpression="OrderNo">
                                        <ItemTemplate>
                                           <%-- <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>'><%# Eval("OrderNo") %></a>--%>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Online'><%# Eval("OrderNo") %></a>
                                        </ItemTemplate>
...
<%--                                    <telerik:GridTemplateColumn HeaderText="Name" SortExpression="Name">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Email" SortExpression="email">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Online'><%# Eval("email") %></a>
                                        </ItemTemplate>
                                 ...
                                 <%--  <telerik:GridBoundColumn DataField="Status" HeaderText="Status" AllowFiltering="false" HeaderStyle-Font-Underline="true" 
                                      ...
                                      <telerik:GridBoundColumn DataField="TxnId" HeaderText="TransactionId" AllowFiltering="false" HeaderStyle-Font-Underline="true" 
                                        SortExpression="TxnId" UniqueName="TxnId">
                                    </telerik:GridBoundColumn>

                                      <telerik:GridBoundColumn DataField="TxnStatus" HeaderText="Status" AllowFiltering="false" HeaderStyle-Font-Underline="true" 
                                        SortExpression="TxnStatus" UniqueName="TxnStatus">
                                    </telerik:GridBoundColumn>
                               ...
                               <%--     <telerik:GridTemplateColumn HeaderText="Status" SortExpression="Status">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Total Amounts" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" SortExpression="TotalAmount">
                                      ...
                                      <telerik:GridTemplateColumn HeaderText="Print">
                                        <ItemTemplate>
                                            <a href='PrintOrderDetails.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Online' target="_blank">Print</a>
                                        </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="dsOrders" runat="server"
                            ...
                            SelectCommand="SELECT * from View_Orders where TxnStatus='success' or TxnStatus='captured' and OrderFrom='Online' order by CreatedOn desc"></asp:SqlDataSource>
