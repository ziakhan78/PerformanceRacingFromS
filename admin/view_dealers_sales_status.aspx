<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_dealers_sales_status.aspx.cs" Inherits="admin_view_dealers_sales_status" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="txt" style="width: 100%;">
                <tr>
                    <td class="header_title" colspan="3">View Dealer Sales Status</td>
                </tr>
                            ...
                            <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" DataSourceID="dsOrders">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Order No." SortExpression="OrderNo">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Dealer'><%# Eval("OrderNo") %></a>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="CompanyName" SortExpression="CompanyName">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Dealer'><%# Eval("CompanyName")%></a>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Email" SortExpression="EmailId">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Dealer'><%# Eval("EmailId") %></a>
                                        </ItemTemplate>
