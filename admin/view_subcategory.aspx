<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_subcategory.aspx.cs" Inherits="admin_view_subcategory" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Sub Category</td>
                </tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="center" width="100%">
                                        ...
                                        <asp:DropDownList ID="ddlCat" runat="server" AppendDataBoundItems="True"
                                            RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="ddlCat_SelectedIndexChanged" DataSourceID="dsCat" DataTextField="cat_name" DataValueField="cid" CssClass="txtBox">
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="sid">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="cat_name" HeaderText="Category"
                                     ...
                                     <telerik:GridBoundColumn DataField="hs_code" HeaderText="HS Code"
                                        SortExpression="hs_code" UniqueName="hs_code">
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" Font-Underline="true"  />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" ></ItemStyle>
                                    </telerik:GridBoundColumn>

                                      <telerik:GridBoundColumn DataField="CustomDuty" HeaderText="Custom Duty"
                                        SortExpression="CustomDuty" UniqueName="CustomDuty">
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" Font-Underline="true"  />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" ></ItemStyle>
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_subcategory.aspx?id=<%# Eval("sid") %>'>
