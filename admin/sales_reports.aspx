<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="sales_reports.aspx.cs" Inherits="admin_sales_reports" %>
        ...
        <ContentTemplate>
            <div align="center" style="vertical-align: top;">
                <table class="txt" style="width: 100%;" align="center" cellpadding="0" cellspacing="5">
                    ...
                    <tr>
                        <td class="header_title">Export to Excel Sales Report</td>
                    </tr>
                                        ...
                                        <td width="600"><b>
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server"
                                                ...
                                                <asp:ListItem Value="2">Processing</asp:ListItem>
                                                 ...
                                                 <asp:ListItem Value="4">Customer Wise</asp:ListItem>
                                                <asp:ListItem Value="5">Date Wise</asp:ListItem>
                                            </asp:RadioButtonList></b>
                                        </td>  
                                        
                                          <td align="left">
                                <asp:DropDownList ID="DDLCustomer" runat="server" AutoPostBack="True" AppendDataBoundItems="true" DataSourceID="dsCustomer" DataTextField="Name" DataValueField="Cust_Id" CssClass="txt" OnSelectedIndexChanged="DDLCustomer_SelectedIndexChanged">
                                ...
                                <asp:Panel ID="PanelDate" runat="server">
                                    <table class="style5">
                                        <tr>
                                            <td>From:</td>
                                            <td>
                                                <telerik:RadDatePicker ID="dateFrom" runat="server" Width="110px">
                                            ...
                                            <td>To:</td>
                                            <td>
                                                <telerik:RadDatePicker ID="dateTo" runat="server" Width="110px">
                                                    <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False"
                                                        ViewSelectorText="x">
                                                    </Calendar>
                                                    <DatePopupButton HoverImageUrl="" ImageUrl="" />
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <asp:SqlDataSource ID="DSSalesReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT * from View_Orders where TxnStatus='success' or TxnStatus='captured' order by CreatedOn desc"></asp:SqlDataSource>
                        ...
                        <td align="center">
                            <div>
                                ...
                                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/admin_icons/exl.gif" ToolTip="Export to Excel"
                                 ...
                                 <asp:SqlDataSource ID="dsCustomer" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT distinct Cust_Id, Name FROM [View_Orders] ORDER BY [Name]"></asp:SqlDataSource>
