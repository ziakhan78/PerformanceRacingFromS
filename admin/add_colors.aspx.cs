...
public partial class Admin_AddOccasions : System.Web.UI.Page
{
    ...
    private void GetColors(int id)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            lblHeading.Text = "Edit Colours";
            txtColor.Text = dt.Rows[0]["color_name"].ToString();
            txtColorCode.Text = dt.Rows[0]["hex_code"].ToString();
        }
    ...
    private void AddColor()
    {
        try
        {
            ...
            objColor.HexCode = txtColorCode.Text.Trim().ToString();
    ...
    private void Clear()
    {
        txtColor.Text = "";
        txtColorCode.Text = "";       
        lblColorCode.BackColor = System.Drawing.ColorTranslator.FromHtml(txtColorCode.Text);
    }   
