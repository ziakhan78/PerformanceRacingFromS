...
public partial class Admin_add_store_order : System.Web.UI.Page
{
    string cartid = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Session["value"] = null;
            lblHeading.Text = "Add Store Order";
        }
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {           
            ...
            UpdateFinalCart(cartid);
            Session["CartID"] = null;
            ShowMsg("Order has been created sucessfully.","add_store_order.aspx");
        }
    }
