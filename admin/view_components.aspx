<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_components.aspx.cs" Inherits="Admin_view_components" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Components</td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_component_master.aspx?id=<%# Eval("id") %>'>
                        ...
                        <%-- <asp:SqlDataSource ID="DSComponents" runat="server"
                            ...
                            SelectCommand="SELECT * FROM components_master_tbl order by components"></asp:SqlDataSource>--%>
                    </td>
                </tr>
                <tr>
