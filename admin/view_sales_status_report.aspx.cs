...
public partial class admin_view_sales_status_report : System.Web.UI.Page
{
    ...
    private void SearchGrid(string searchField, string pname)
    {
        DataTable dt = new DataTable();
        DBconnection obj = new DBconnection();
        obj.SetCommandQry = "SELECT * from View_Orders  where TxnStatus='success' or TxnStatus='captured' and " + searchField + " like  '%'+'" + pname + "'+ '%' order by CreatedOn desc";
    ...
    private void BindGridDate()
    {
        ...
        obj.SetCommandSP = "z_SortOrderbyDateRange";
