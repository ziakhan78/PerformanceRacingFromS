<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="ViewDealersOrders.aspx.cs" Inherits="admin_ViewDealersOrders" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="txt" style="width: 100%;">
                <tr>
                    <td class="header_title" colspan="3">View Dealers Sales Reports</td>
                </tr>
                            ...
                            <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" DataSourceID="dsOrders">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Order No." SortExpression="OrderNo">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("id") %>&type=Dealer'><%# Eval("OrderNo") %></a>
                                        </ItemTemplate>
...
<%--                                    <telerik:GridTemplateColumn HeaderText="Name" SortExpression="Name">
                                      ...
                                      <telerik:GridTemplateColumn HeaderText="Name" SortExpression="CompanyName">
                                        <ItemTemplate>
                                             <a href="javascript:void(0)" onclick="MM_openBrWindow('ViewCustomerDetails.aspx?custID=<%# Eval("id") %>','01111','width=650,height=450')"><%# Eval("CompanyName") %></a>                       
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Email" SortExpression="EmailId">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("id") %>&type=Dealer'><%# Eval("EmailId") %></a>
                                        </ItemTemplate>
                               ...
                               <%--     <telerik:GridTemplateColumn HeaderText="Status" SortExpression="Status">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Total Amounts" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" SortExpression="TotalAmount">
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Print">
                                        <ItemTemplate>
                                            <a href='PrintOrderDetails.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Dealer' target="_blank">Print</a>
                                        </ItemTemplate>
