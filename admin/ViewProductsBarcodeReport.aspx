<%@ Page Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="ViewProductsBarcodeReport.aspx.cs" Inherits="Admin_ViewProductsBarcodeReport" %>
        ...
        <ContentTemplate>
            <div align="center" style="vertical-align: top;">
                ...
                <table class="txt" style="width: 100%;" align="center" cellpadding="0" cellspacing="5">
                    ...
                    <tr>
                        <td class="header_title" colspan="2">View Products Barcode</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="dsProduct"
                                Skin="Default" PageSize="25" CssClass="treeView"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="No. of Label">
                                            <ItemTemplate>
                                                ...
                                                <%-- <asp:TextBox ID="txtNoOfLabel" runat="server"></asp:TextBox>--%>
                                                <telerik:RadNumericTextBox ID="txtNoOfLabel" runat="server" Width="40" MaxLength="3" NumberFormat-DecimalDigits="0" CssClass="txtBox" ></telerik:RadNumericTextBox>
                                            </ItemTemplate>
