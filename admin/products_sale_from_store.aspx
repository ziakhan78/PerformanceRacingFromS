<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="products_sale_from_store.aspx.cs" Inherits="admin_products_sale_from_store" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="txt" style="width: 100%;" align="center" cellpadding="3" cellspacing="5">
        ...
        <tr>
            <td align="right" class="style7"><span class="style12">*</span> Bill Amount :</td>
            <td class="style10">
