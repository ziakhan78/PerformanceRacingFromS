<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_manufacturer_master.aspx.cs" Inherits="Admin_view_manufacturer_master" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Motorcycle Manufacturer</td>
                </tr>
                                ...
                                <tr>
                                    <td valign="top" align="left">
                                        <asp:RadioButtonList ID="rbtnSearch" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Selected="True" Value="0">Manufacturer</asp:ListItem>
                                        </asp:RadioButtonList>
                ...
                <tr>
                    <td colspan="3">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="manufacturer_name" HeaderText="Manufacturer"
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Logo">
                                        <ItemTemplate>
                                            <img src='../ManufacturerLogo/<%#Eval("logo") %>' alt="" style="border-width: 0px; height: 50px; width: 50px;" />
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_manufacturer_master.aspx?id=<%# Eval("id") %>'>
                        ...
                        <%--<asp:SqlDataSource ID="DSmanufacturer" runat="server"
                            ...
                            SelectCommand="SELECT * FROM [manufacturer_master_tbl] order by manufacturer_name"></asp:SqlDataSource>--%>
                    </td>
                </tr>
                <tr>
