<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_promotions_occasion.aspx.cs" Inherits="admin_view_promotions_occasion" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Promotion Events</td>
                </tr>

                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" DataSourceID="DSPOccasions"
                            AllowSorting="True" Skin="Default" PageSize="25" OnItemCommand="RadGrid1_ItemCommand" GridLines="None">
                            <HeaderContextMenu EnableAutoScroll="True"></HeaderContextMenu>

                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="DSPOccasions">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="occasion_name" HeaderText="Promotion Events"
                                        SortExpression="occasion_name" UniqueName="occasion_name">
                                      ...
                                      <telerik:GridBoundColumn DataField="occasion_abbri" HeaderText="Abbreviation"
                                        SortExpression="occasion_abbri" UniqueName="occasion_abbri">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" />
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_promotions_occasions.aspx?id=<%# Eval("id") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="DSPOccasions" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="SELECT * FROM [Promotions_Occasion_tbl] order by occasion_name"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
