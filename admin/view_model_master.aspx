<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_model_master.aspx.cs" Inherits="Admin_view_model_master" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Motorcycle Model</td>
                </tr>
                                ...
                                <tr>
                                    <td valign="top" align="left">
                                        <asp:RadioButtonList ID="rbtnSearch" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rbtnSearch_SelectedIndexChanged">
                                            <asp:ListItem Selected="True" Value="0">Model</asp:ListItem>
                                ...
                                <tr>
                                    <td valign="top" align="left">
                                        <asp:TextBox ID="txtName" runat="server" CssClass="txtBox" Width="300px"></asp:TextBox>
                                         <asp:DropDownList ID="DDLManufacturer" runat="server" CssClass="txtBox" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="manufacturer_name" DataValueField="id" AutoPostBack="True" OnSelectedIndexChanged="DDLManufacturer_SelectedIndexChanged">
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" 
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" >
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="manufacturer_name" HeaderText="Manufacturer"
                                   ...
                                   <telerik:GridBoundColumn DataField="year_from" HeaderText="Year From" DataFormatString="{0:yyyy}"
                                        SortExpression="year_from" UniqueName="year_from">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" />
                                      ...
                                      <telerik:GridBoundColumn DataField="year_to" HeaderText="Year To" DataFormatString="{0:yyyy}"
                                        SortExpression="year_to" UniqueName="year_to">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle HorizontalAlign="Left" Font-Bold="true" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_model_master.aspx?id=<%# Eval("id") %>'>
                       ...
                       <%-- <asp:SqlDataSource ID="DSBrand" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="SELECT * FROM [View_ManufacturerModel] order by manufacturer_name, model "></asp:SqlDataSource>--%>
                    </td>
                </tr>
                <tr>
