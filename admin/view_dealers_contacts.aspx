<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_dealers_contacts.aspx.cs" Inherits="admin_view_dealers_contacts" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                <tr >
                    <td align="center" colspan="2" class="header_title">View Dealers Contacts</td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td colspan="2">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="CompanyName" HeaderText="Company"
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_dealers_contacts.aspx?id=<%# Eval("id") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
                       ...
                       <%-- <asp:SqlDataSource ID="DSDealersContacts" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="SELECT * FROM [View_DealersContacts] order by CompanyName"></asp:SqlDataSource>--%>
                    </td>
                </tr>
                <tr>
