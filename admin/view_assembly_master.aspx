<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_assembly_master.aspx.cs" Inherits="Admin_view_assembly_master" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Assembly</td>
                </tr>

                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" DataSourceID="DSAssembly"
                            AllowSorting="True" Skin="Default" PageSize="100" OnItemCommand="RadGrid1_ItemCommand" GridLines="None">
                            <HeaderContextMenu EnableAutoScroll="True"></HeaderContextMenu>

                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="DSAssembly">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="assembly" HeaderText="Assembly"
                                        SortExpression="assembly" UniqueName="assembly">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_assembly_master.aspx?id=<%# Eval("id") %>'>
                        ...
                        <asp:SqlDataSource ID="DSAssembly" runat="server"
                            ...
                            SelectCommand="SELECT * FROM [assembly_master_tbl] order by assembly"></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
