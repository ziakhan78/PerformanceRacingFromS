...
public partial class admin_view_dealer_details : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
               ...
               // lblWorkingTime.Text = dt.Rows[0]["WorkingTimeStart"].ToString() + " " + dt.Rows[0]["WorkingTimeEnd"].ToString();
                ...
                lblCreditFacility.Text = dt.Rows[0]["CreditFacility"].ToString();
                ...
                lblCreditPeriod.Text = dt.Rows[0]["CreditPeriod"].ToString();
                lblCreditLimit.Text = dt.Rows[0]["CreditLimit"].ToString();
