<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_sales_status_report.aspx.cs" Inherits="admin_view_sales_status_report" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="txt" style="width: 100%;">
                <tr>
                    <td class="header_title" colspan="3">View Sales Status Reports</td>
                </tr>
                ...
                <tr>
                    <td align="left" colspan="3">
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server"
                            ...
                            Skin="Default" PageSize="25" CssClass="mainlinks" OnItemDataBound="RadGrid1_ItemDataBound">
                    ...
                    <PagerStyle BackColor="#E9E0ED" />--%>
                            <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" DataSourceID="dsOrders">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Name" SortExpression="Name">
                                        <ItemTemplate>
                                            <a href='OrderDetail.aspx?CartID=<%# Eval("Cart_Id") %>&CustID=<%# Eval("Cust_Id") %>&type=Online'><%# Eval("Name")%></a>
                                        </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="dsOrders" runat="server"
                            ...
                            SelectCommand="SELECT * from View_Orders where TxnStatus='success' or TxnStatus='captured' order by CreatedOn desc"></asp:SqlDataSource>
