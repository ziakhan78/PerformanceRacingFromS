<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_hsn_master.aspx.cs" Inherits="admin_view_hsn_master" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td align="center" class="header_title">View HS Code, GST & Custom Duty Master</td>
                </tr>

                 <tr>
                    <td colspan="3">
                         <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" DataSourceID="DSHsMaster"
                            AllowSorting="True" Skin="Default" PageSize="100" OnItemCommand="RadGrid1_ItemCommand" GridLines="None">
                            <HeaderContextMenu EnableAutoScroll="True"></HeaderContextMenu>

                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="DSHsMaster">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="HSCode" HeaderText="HS Code"
                                        SortExpression="HSCode" UniqueName="HSCode">
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_hsn_master.aspx?id=<%# Eval("id") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="DSHsMaster" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="SELECT * FROM [hs_code_master_tbl] "></asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
