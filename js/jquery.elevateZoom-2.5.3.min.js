...
(c("#"+d.options.gallery+" a").removeClass(d.options.galleryActiveClass),c(this).addClass(d.options.galleryActiveClass));a.preventDefault();d.zoomImagePre=c(this).data("zoom-image")?c(this).data("zoom-image"):c(this).data("image");d.swaptheimage(c(this).data("image"),d.zoomImagePre);return!1})},refresh:function(a){var b=this;setTimeout(function(){b.fetch(b.imageSrc)},a||b.options.refresh)},fetch:function(a){var b=this,d=new Image;d.onload=function(){b.largeWidth=d.width;b.largeHeight=d.height;b.startZoom();
b.currentImage=b.imageSrc;b.options.onZoomedImageLoaded()};d.src=a},startZoom:function(){var a=this;a.nzWidth=a.$elem.width();a.nzHeight=a.$elem.height();a.nzOffset=a.$elem.offset();a.widthRatio=a.largeWidth/a.options.zoomLevel/a.nzWidth;a.heightRatio=a.largeHeight/a.options.zoomLevel/a.nzHeight;"window"==a.options.zoomType&&(a.zoomWindowStyle="overflow: hidden;background-position: 0px 0px;text-align:center;background-color: "+String(a.options.zoomWindowBgColour)+";width: "+String(a.options.zoomWindowWidth)+
...
-1*(this.nzHeight-this.zoomLens.height()-2*this.options.lensBorderSize));this.Eroppos&&(this.tintpos=-1*(this.nzWidth-this.zoomLens.width()-2*this.options.lensBorderSize));this.options.tint&&(this.zoomTint.css({opacity:this.options.tintOpacity}).animate().fadeIn("slow"),this.zoomTintImage.css({left:this.tintpos-this.options.lensBorderSize+"px"}),this.zoomTintImage.css({top:this.tintposy-this.options.lensBorderSize+"px"}))},swaptheimage:function(a,b){var d=this,c=new Image;d.options.onImageSwap(d.$elem);
c.onload=function(){d.largeWidth=c.width;d.largeHeight=c.height;d.zoomImage=b;d.swapAction(a,b)};c.src=b},swapAction:function(a,b){var d=this,c=new Image;c.onload=function(){d.nzHeight=c.height;d.nzWidth=c.width;d.options.onImageSwapComplete(d.$elem);d.doneCallback()};c.src=a;d.zoomWindow.css({backgroundImage:"url('"+b+"')"});d.currentImage=b;d.$elem.attr("src",a)},doneCallback:function(){this.options.tint&&(this.zoomTintImage.attr("src",largeimage),this.zoomTintImage.attr("height",this.$elem.height()),
...
this.options.zoomWindowWidth/this.widthRatio;this.zoomLens.css("width",lensWidth);this.zoomLens.css("height",lensHeight)},getCurrentImage:function(){return this.zoomImage},getGalleryList:function(){var a=this;a.gallerylist=[];a.options.gallery?c("#"+a.options.gallery+" a").each(function(){var b="";c(this).data("zoom-image")?b=c(this).data("zoom-image"):c(this).data("image")&&(b=c(this).data("image"));b==a.zoomImage?a.gallerylist.unshift({href:""+b+"",title:c(this).find("img").attr("title")}):a.gallerylist.push({href:""+
b+"",title:c(this).find("img").attr("title")})}):a.gallerylist.push({href:""+a.zoomImage+"",title:c(this).find("img").attr("title")});return a.gallerylist},changeZoomLevel:function(a){this.widthRatio=this.largeWidth/a/this.nzWidth;this.heightRatio=this.largeHeight/a/this.nzHeight;this.zoomWindow.css({"background-size":this.largeWidth/a+"px "+this.largeHeight/a+"px"});this.zoomLens.css({width:String(this.options.zoomWindowWidth/this.widthRatio)+"px",height:String(this.options.zoomWindowHeight/this.heightRatio)+
"px"});this.options.zoomLevel=a},closeAll:function(){self.zoomWindow&&self.zoomWindow.hide();self.zoomLens&&self.zoomLens.hide();self.zoomTint&&self.zoomTint.hide()}};c.fn.elevateZoom=function(a){return this.each(function(){var b=Object.create(e);b.init(a,this);c.data(this,"elevateZoom",b)})};c.fn.elevateZoom.options={zoomLevel:1,easing:!1,easingAmount:12,lensSize:100,zoomWindowWidth:600,zoomWindowHeight:600,zoomWindowOffetx:0,zoomWindowOffety:0,zoomWindowPosition:1,zoomWindowBgColour:"#fff",lensFadeIn:!1,
...
onImageSwapComplete:c.noop}})(jQuery,window,document);