...
public partial class forgot_password : System.Web.UI.Page
{
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            con.SetCommandSP = "sc_forgot_password";
            ...
            if (obj.Rows.Count > 0)
            {
                ...
                string name = obj.Rows[0]["billFName"].ToString() + " " + obj.Rows[0]["billLName"].ToString();
                string username = obj.Rows[0]["email"].ToString();
    ...
    protected void CVEmail_ServerValidate(object source, ServerValidateEventArgs args)
    {
        try
        {
            ...
            obj.SetCommandQry = "select Email from Customers_tbl where email='" + txtEmail.Text.Trim().ToString() + "' and is_email_verified='True'";
